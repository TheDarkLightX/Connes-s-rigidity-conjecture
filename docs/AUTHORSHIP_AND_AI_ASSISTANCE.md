...
- generate candidate generalizations, including the ternary rank-three Witt-carry program;
...
5. avoid claiming a completed counterexample to Connes's rigidity conjecture until the property-(T), ICC, intrinsic-invariant, and operator-algebra bridges are closed.
